...
class EventsController extends BaseController
{
    ...
    public function getFutureEventsWithWorkshops() {
        ...
        $future_workshop_ids_obj = DB::table('workshops')
            ->select('id')
            ->where('start' , '>=' , Carbon::now()->toDateTimeString())
            ->get();
        
        foreach($future_workshop_ids_obj as $obj) {
            array_push($future_workshops, $obj->id);
        }

        return Event::with('workshops')->whereIn('id', $future_workshops)->get();
    }
}
